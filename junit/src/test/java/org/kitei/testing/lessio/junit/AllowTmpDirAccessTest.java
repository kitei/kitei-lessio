...
public class AllowTmpDirAccessTest extends AbstractLessIOSecurityManagerTest
{
    protected class DisallowedOperation implements RunnableWithException
    {
        ...
        {
            final File f = new File(System.getProperty("java.io.tmpdir"), "AllowLocalFileAccessTest");
            f.exists();
        }
    }
